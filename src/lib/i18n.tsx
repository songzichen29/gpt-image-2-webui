...
const en = {
    ...
    'settings.baseUrlPlaceholder': 'https://api.774966.xyz/v1',
    'settings.baseUrlHelp': 'Leave empty to use https://api.774966.xyz/v1.',
    ...
    'home.fixedEndpoint': 'Fixed endpoint: {url}',
...
const zh: Translations = {
    ...
    'settings.baseUrl': 'Base URL',
    'settings.baseUrlPlaceholder': 'https://api.774966.xyz/v1',
    'settings.baseUrlHelp': '留空时默认使用 https://api.774966.xyz/v1。',
    'settings.apiKey': 'API Key',
    'settings.apiKeyPlaceholder': 'sk-...',
