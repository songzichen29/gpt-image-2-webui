...
const en = {
    ...
    'help.retention':
        'Server-side images are kept for about 1 day by the object storage lifecycle. Important images should be downloaded in time.',
    ...
    'history.serverExpiryCountdown': 'Online image cleanup in about {time}. Estimated expiry: {date}.',
...
const zh: Translations = {
    ...
    'help.retention': '服务端图片由对象存储生命周期保留约 1 天后自动清理，重要结果请及时下载保存。',
    ...
    'history.serverExpiryCountdown': '线上图片约 {time} 后清理，预计过期时间：{date}。',
    'history.serverExpiryCountdownShort': '线上 {time} 后清理',
    'history.serverExpiryExpired': '线上图可能已清理',
    'history.serverExpiryExpiredDetail': '这条记录已超过对象存储生命周期保留时间，预计过期时间：{date}。',
    'history.serverExpiryNotice':
